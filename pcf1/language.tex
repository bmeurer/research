...
\begin{itemize}
  \item $D^\sexp = \CExp$, $\supp{e} = \locns{e}$
...
\begin{proof}
  ...
  \begin{itemize}
    \item $v \in \semantic{\tau}_L \\
           ...
           L = \locns{v} \\
           \,\Leftrightarrow\,
           \mu(L) = \mu\,(\locns{v}) = \locns{\mu^\sexp\,v} = \locns{\mu^\tau\,v} \\
           \,\Leftrightarrow\,
           (\mu^\tau\,v) \in \semantic{\tau}_{\mu(L)}$

          Since $\mu^\sexp$ is bijective, $(\mu^\tau)^{-1}\,v'$ is in
    ...
    \item Let $\phi \in \semantic{\tassn}_L$, then
          \begin{itemize}
            \item $\phi\in\DEF_L
                   ...
                   \,\Rightarrow\,
                   (\phi \circ (\mu^\ssto)^{-1}) \in \DEF_{\mu(L)}$
            ...
            \item $\bar{\mu}\in\Perm_{\mu(L)} \\
                   ...
                   \,\Rightarrow\,
                   \phi\circ (\mu^\ssto)^{-1} = \phi \circ (\mu^\ssto)^{-1} \circ (\bar{\mu}^\Sto)^{-1}$
          \end{itemize}
          and therefore $(\phi\circ(\mu^\ssto)^{-1}) = (\mu^\tassn\,\phi) \in \semantic{\tassn}_{\mu(L)}$.
          $\mu^\tassn$ is bijective, because $\mu^\ssto$ is bijective.
...
\begin{lemma}[Total correctness]
  ...
  \begin{enumerate}
    ...
    \item If $\supp{\phi,e,\psi} \subseteq L \cap L'$ then the following are equivalent
          \begin{enumerate}
            \item $L\models\triple{\phi}{e}{\psi}$
            \item $L'\models\triple{\phi}{e}{\psi}$
          \end{enumerate}
  \end{enumerate}
\end{lemma}
