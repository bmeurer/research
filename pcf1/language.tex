...
The {\em meaning function} $\semantic{\tj{t}{\theta}}: \Env_t \to \semantic{\theta}$ for terms $t \in \Term$.
\begin{itemize}
  \item $\semantic{\tj{v}{\tau}}\,\eta := v\,\eta$
  \item $\semantic{\tj{f}{\theta}}\,\eta := f^\I$
  \item $\semantic{\tj{\app{t_1}{t_2}}{\theta}}\,\eta :=
          (\semantic{\tj{t_1}{\ttarrow{\theta'}{\theta}}}\,\eta)\,
          (\semantic{\tj{t_2}{\theta'}}\,\eta)$
  \item $\semantic{\tj{\tabstr{x^\theta}{t}}{\ttarrow{\theta}{\theta'}}}\,\eta := f$ \\
        $f: \semantic{\theta} \to \semantic{\theta'}, d \mapsto \semantic{\tj{t}{\theta'}}\,(\eta[d/x])$
\end{itemize}
...
\begin{itemize}
  ...
  \item $\I_\exists: \semantic{\pi_1} \to (\semantic{\pi_2} \to \semantic{\tassn}) \to \semantic{\tassn}$ \\[1ex]
        $\I_\exists\,d_1\,f\,s =
          \bcase
            \uparrow  & \text{if } s \not\in \dom{f\,d_2}
                        \text{ for some }d_2 \in \bigcup_{L'\subseteq\reach{\supp{d_1}}{s}}\semantic{\pi}_{L'} \\
