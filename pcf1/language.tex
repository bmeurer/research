...
({\bf TODO:} add formulas and terms)

\begin{theorem}[Substitution] \label{theorem:Substitution}
  Let $\tau\in\Type$, $\pi\in\PType$, $p \in \Assn^{\ttarrow{\tau}{\pi}}$, $v\in\CVal^\tau$,
  $x\in\Var$ and $\eta\in\Env_p$. Then
  $(\semantic{\tj{p}{\ttarrow{\tau}{\pi}}}\,\eta)\,v
   = \semantic{\tj{p\,x}{\pi}}\,(\eta[v/x])$.
\end{theorem}
  ...
  \begin{itemize}
    ...
    \item For \RN{Beta-V} let $e \in \Exp$ and $\eta \in \Env_e$, then
          ...
          \[\begin{array}{rl}
            ...
            \text{if} & (e\,\eta',s) \xrightarrow* (v',s') \text{ since } \free{e'} = \{x\} \\
    ...
    \item For \RN{Deref} let $\eta\in\Env$, then
          \[\begin{array}{rl}
            ...
            \text{if} & (\semantic{\tj{a\,y}{\tassn}}\,(\eta'[v'/y]))\,s=\true
                        \text{ by theorem~\ref{theorem:Substitution}} \\
...
%%
%% Axioms rules for total correctness
%%
