...
the expression that results from replacing every variable in $e$ with its respective value in $\eta$. It is
...
\end{array}\]
\begin{itemize}
  \item $\semantic{\tj{\qbex{x^\theta}{t}{p}}{\tassn}}\,\eta :=
          \Exists\,(\semantic{\tj{t}{\sigma}}\,\eta)\,\psi$ \\[1ex]
        $\psi: \semantic{\theta} \to \semantic{\tassn}, d \mapsto \semantic{\tj{p}{\tassn}}\,(\eta[d/x])$
\end{itemize}
