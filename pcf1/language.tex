...
\begin{proof}
  ...
  \end{array}\]
%  The proof of the
%  second property is also pretty much straightforward. Again, let $d \in \semantic{\sigma}$, then
%  \[\begin{array}{rcl}
%    \semantic{\tj{\tabstr{x^\sigma}{t}}{\ttarrow{\sigma}{\sigma'}}}\,(\mu^\senv\,\eta)\,d
%    &=& \semantic{\tj{t}{\sigma'}}\,((\mu^\senv\,\eta)[d/x]) \\
%    &=& \semantic{\tj{t}{\sigma'}}\,(\mu^\senv\,(\eta[(\mu^\sigma)^{-1}\,d/x])) \\
%    &=& \hat{\mu}^{\sigma'}\,(\semantic{\tj{t}{\sigma'}}\,(\hat{\eta}[(\hat{\mu}^\sigma)^{-1}\,d/x])) \\
%    &=& \hat{\mu}^{\sigma'}\,((\semantic{\tj{\tabstr{x^\sigma}{t}}{\ttarrow{\sigma}{\sigma'}}}\,\hat{\eta})\,
%                        ((\hat{\mu}^\sigma)^{-1}\,d) \\
%    &=& (\hat{\mu}^{\ttarrow{\sigma}{\sigma'}}\,(\semantic{\tj{\tabstr{x^\sigma}{t}}{\ttarrow{\sigma}{\sigma'}}}\,
%                        \hat{\eta}))\,d.
%  \end{array}\]
\end{proof}
