...
\begin{lemma}
  ...
  \begin{itemize}
    ...
    \item $\Cont\,\semantic{\tref{\tau}}_{L_1}\,\semantic{\tau} \subseteq \semantic{\tassn}_{L_1}$
...
\begin{proof}
  ...
  \begin{itemize}
    ...
    \item Let $d_1 \in \semantic{\theta_1}_{L_1}$,
          ...
          Then again, there exist $d_2 \in \semantic{\theta_2}_L$, $L \subseteq \reach{L_1}{s}$ such
          that $\psi\,d_2\,s=\true$. But then there also exist $d_2'\in\semantic{\theta_2}_{L'}$,
          $L' \subseteq \reach{L_1}{(\mu^\ssto)^{-1}\,s}$ such that $\psi\,(\mu^{\theta_2}\,d_2')\,s=\true$.
...
\begin{lemma}
  Let $\pi \in \PType$, $p \in \Assn^\pi$, $\eta,\hat{\eta} \in \Env_p$ and $\mu,\hat{\mu}\in\Perm$. Then
  we have
  \begin{enumerate}
