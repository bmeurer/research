...
%\begin{lemma}
%  Let $\tau\in\Type$, $\theta_1,\theta_2 \in \LType$, $\phi_1,\phi_2 \in \semantic{\tassn}$,
%  $l\in\semantic{\tref{\tau}}$, $v\in\semantic{\tau}$, $d_1\in\semantic{\theta_1}$,
%  $d_2 \in \semantic{\theta_2}$ and $\mu\in\Perm$.
%  \begin{itemize}
%    \item $\Neg\,(\mu^\tassn\,\phi_1)
%          = \mu^\tassn\,(\Neg\,\phi_1)$
%    \item $\Or\,(\mu^\tassn\,\phi_1)\,(\mu^\tassn\,\phi_2)
%          = \mu^\tassn\,(\Or\,\phi_1\,\phi_2)$
%    \item $\Cont\,(\mu^{\tref{\tau}}\,l)\,(\mu^\tau\,v)
%          = \mu^\tassn\,(\Cont\,l\,v)$
%    \item $\Disj\,(\mu^{\theta_1}\,d_1)\,(\mu^{\theta_2}\,d_2)
%          = \mu^\tassn\,(\Disj$
%  \end{itemize}
%\end{lemma}
