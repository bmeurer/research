...
\DeclareMathOperator{\sepimp}{-\kern-.05em\ast}
...
%\newcommand{\tassn}[1]{#1\,\pstyle{assn}}
\newcommand{\tassn}[1][]{{\ifthenelse{\equal{#1}{}}{}{#1\,}}\pstyle{assn}}
...
\newcommand{\unit}{\pstyle{unit}}
\newcommand{\proj}[2]{\pstyle{proj}^{#1}_{#2}}
...
%\newcommand{\ttuple}[1]{\langle\kern-0.25em\langle#1\rangle\kern-0.25em\rangle}
\newcommand{\ttuple}[1]{(#1)}
...
\newcommand{\triplex}[4]{\triple{#1}{{#2}_{:{#3}}}{#4}}
