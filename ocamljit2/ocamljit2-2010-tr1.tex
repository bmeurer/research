...
Just-In-Time compilation is still a very active research field \cite{Arnold04,Aycock03}.
...
Language (CLI) \cite{Ecma335} instruction sets are not as optimized as the \textsc{OCaml} byte-code.
