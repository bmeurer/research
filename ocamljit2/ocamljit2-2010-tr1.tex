...
the supported targets, but it is only applicable to \emph{static program compilation}.
For example, it cannot be used with multi-stage programming in \textsc{MetaOCaml}
\cite{Taha06}, or the interactive top-level \texttt{ocaml}.
...
stack-based languages like \textsc{Forth} \cite{Ertl93}. 
Several of the ideas used in \textsc{Forth} to native code generation
\cite{Ertl92,Ertl96,ErtlPirker97,ErtlPirker98} may also be applicable in
the context of JIT compilation of \textsc{OCaml} byte-code.
