...
is mostly because of the additional overhead that comes with multi-threading,
class loading and object synchronization. But it is also due to the fact that
