...
The generated native code for \texttt{ANDINT} on x86\_64 is shown in figure~\ref{figure:ANDINT_native_code}.
...
instruction pops the top-most stack cell (the \textsc{OCaml} stack grows towards lower addresses).
...
\begin{figure}[ht]
  ...
  addq $8, %r14
\end{verbatim}
  \caption{\texttt{ANDINT} native code (x86\_64)}
