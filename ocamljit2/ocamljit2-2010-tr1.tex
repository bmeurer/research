...
allocation in general is far from optimal. This is due to the naive
compilation scheme. For example, most of the generated code uses less than
a fourth of the registers provided by the x86-64 processor.
...
or long lived interactive top-level shells. We plan to address this
