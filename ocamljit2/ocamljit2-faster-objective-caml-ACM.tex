...
\markboth{Benedikt Meurer}{OCamlJIT 2.0 - Faster Objective Caml}
\title{OCamlJIT 2.0 - Faster Objective Caml}
\author{BENEDIKT MEURER\\University of Siegen}
...
\category{D.3.4}{Programming Languages}{Processor}[Code generation \and Incremental compilers]

\terms{Languages, Performance}

\keywords{Just-In-Time compilation, Machine Code Generation, OCaml}

\begin{document}

\begin{bottomstuff}
Author's address: B. Meurer, Compiler Construction and Software Analysis Group,
University of Siegen, D-57072 Siegen, Germany.
\end{bottomstuff}
\maketitle
...
The \textsc{OCaml} system \cite{Leroy10,Remy02} is the main implementation of the Caml
...
We present the existing \textsc{OCaml} system and the previous \textsc{OCamlJit} implementation \cite{Starynkevitch04},
which is based on the \textsc{Gnu Lightning} library \cite{Bonzini10}. For the sake of completeness
...
The \textsc{OCaml} virtual machine (see file \linebreak[4]\texttt{byterun/interp.c}) is an interpreter for the
...
\item Field access and modify instructions: $\mathtt{GETGLOBALFIELD}_{p,q}$ loads \texttt{accu} with the
  ...
  and \linebreak[4]$\mathtt{SETSTRINGCHAR}$ are used to access and update characters within strings (the index
...
\texttt{byterun/jit\_rt\_amd64.S} containing the x86-64 runtime setup and helper routines
...
\texttt{almabench.unsafe} & $27.74$ & $9.76$ & $4.35$ & $2.84$ & $2.24$ & $6.38$ & {\tiny(no bounds check)} \\
\texttt{bdd} & $8.50$ & $1.93$ & $0.68$ & $4.41$ & $2.86$ & $12.60$ & binary decision dia. \\
\texttt{boyer} & $4.34$ & $1.68$ & $1.06$ & $2.59$ & $1.59$ & $4.11$ & term processing \\
\texttt{fft} & $5.72$ & $2.17$ & $0.64$ & $2.63$ & $3.39$ & $8.94$ & fast fourier transf. \\
...
\texttt{quicksort.unsafe} & $4.07$ & $0.93$ & $0.20$ & $4.36$ & $4.79$ & $20.86$ & {\tiny(no bounds check)} \\
\texttt{soli} & $0.17$ & $0.03$ & $0.01$ & $5.09$ & $3.40$ & $17.30$ & tiny solitaire \\
\texttt{soli.unsafe} & $0.14$ & $0.02$ & $0.01$ & $6.27$ & $2.75$ & $17.25$ & {\tiny(no bounds check)} \\
\texttt{sorts} & $19.29$ & $7.13$ & $3.71$ & $2.71$ & $1.92$ & $5.19$ & sorting algorithms \\
\hline
...
\texttt{ocamlc -c stdlib/*.ml} & $2.03$ & $0.95$ & $0.67$ & $2.14$ & $1.42$ & $3.04$ & {\tiny(byte-compile)}\\
\texttt{ocamlopt -c stdlib/*.ml} & $5.04$ & $2.36$ & $1.70$ & $2.14$ & $1.39$ & $2.97$ & {\tiny(native-compile)} \\
  \end{tabular}
...
\linebreak[4]\texttt{testsuite/tests} folder of the \textsc{OCaml} 3.12.0 distribution.
...
slow-downs with \textsc{OCamlJit}, benefit from \textsc{OCamlJit2}.
