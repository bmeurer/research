...
wins because of clever floating point optimizations and the use of the SSE2 extension.
...
within the x86 port of \texttt{ocamlopt} here.

In general, floating-point benchmarks benefit the most from the use of \textsc{OCamlJit2},
...
\textsc{OCamlJit2} performance-wise. This is probably caused by the improved compilation
...
approach is somewhat limited. This is mostly related to the nature of the \textsc{OCaml}
...
which mandates the availability of global control and data flow information, which is somewhat
