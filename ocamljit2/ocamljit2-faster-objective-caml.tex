...
our benchmarks). Even though branch target buffers (BTBs) in modern CPUs and various threading techniques
can greatly reduce the number of mispredicted branches, low branch prediction accuracy
is still a major bottleneck in virtual machine interpreters.

Virtual machines based on Just-In-Time compilers are able to reduce almost all indirect branches and thereby
improve the branch prediction accuracy to nearly $98-99\%$ in most cases. A few indirect branches
