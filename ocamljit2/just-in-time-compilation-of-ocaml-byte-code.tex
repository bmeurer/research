...
\textsc{Caml} language, featuring a powerful module system combined with full-fledged
...
and runtime, and with the structure of the \textsc{OCamlJit} and \textsc{OCamlJit2} Just-In-Time
...
within the x86 port of \texttt{ocamlopt} here. We have also spotted some issues with the
