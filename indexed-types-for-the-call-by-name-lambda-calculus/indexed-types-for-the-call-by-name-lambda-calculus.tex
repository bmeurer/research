...
\begin{abstract}
  ...
  safety proofs using subject-reduction. Building on work by Ahmed, Appel and others, we
...
typing judgements, one states typing lemmata and proves their soundness with respect to the semantic
model.
